      ...
      <div className="bg-white dark:bg-dark">
        <div className="max-w-7xl mx-auto px-4 pt-8 ">
              ...
              <div className="mb-4 flex  flex-col-reverse lg:flex-row  justify-between">
                ...
                <div className="flex  items-end">
                  <div className="py-4 px-4 bg-primary dark:bg-blackA  rounded-2xl relative mr-8 h-fit ">
                    ...
                    <LikeIcon className="w-8 h-8 mt-3 m-auto" />
                  </div>
          ...
          <div className="flex mb-16">
            <MinimalFaceIcon className="w-12 h-12 mr-4" />
